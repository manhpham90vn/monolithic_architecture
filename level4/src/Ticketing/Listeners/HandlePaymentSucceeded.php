 ...
 * của Payment đã commit (QĐ-3.12); idempotency nằm trong use-case
 * ConfirmOrderPaid (YC-9.3).
 */
class HandlePaymentSucceeded
{
    public function __construct(private readonly ConfirmOrderPaidHandler $confirmOrderPaid) {}
