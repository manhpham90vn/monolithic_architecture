 ...
 *
 * Đây là đường ĐỌC: nạp thẳng model persistence để dựng email, không cần
 * đi qua aggregate (aggregate chỉ dùng cho đường ghi/bảo vệ bất biến).
 */
class SendOrderConfirmation implements ShouldQueue
{
    ...
    {
        /** @var OrderEloquentModel|null $order */
        $order = OrderEloquentModel::query()->with(['user', 'tickets'])->find($event->orderId);
