        ...
        <div class="card" style="text-align:center;">
            ...
            @isset($ticket)
                <p class="muted" style="margin-top:12px;">
                    ...
                    @if ($result === \App\Enums\CheckInStatus::Used && $ticket->used_at)
