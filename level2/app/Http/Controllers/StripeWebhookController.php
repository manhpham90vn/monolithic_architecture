 ...
 * chỉ kiểm chữ ký (việc của tầng HTTP) rồi giao cho Action ConfirmPayment
 * (QĐ-2.4); idempotency nằm trong Action (YC-9.3).
 */
class StripeWebhookController extends Controller
{
    public function handle(Request $request, ConfirmPayment $confirmPayment): Response
    {
